...
class ClusterData:
    def __init__(self,
        ...
        self.region = region  # NEM region tuple
        ...
        self.nplen = len(self.region) * self.plen
    ...
    def _get_region_data(self, region):
        ...
        first_doy = next_weekday(datetime.date(self.year, 1, 1), self.firstdow)
        last_doy = prev_weekday(datetime.date(self.year, 12, 31), self.lastdow)
...
class CSVCluster(ClusterData):
    """Standalone Cluster, to perform clustering studies"""
    ...
    # TODO add support for AWS openCEM DB #IDEA DbCluster
...
class InstanceCluster(ClusterData):
    def __init__(self, instance, max_d=12):
        self.demand = cemo.jsonify.jsonifyld(
            instance)  # FIXME better names for this
        ClusterData.__init__(self, max_d=max_d)
...
class ClusterRun:
    def __init__(self,
        ...
        self.nemret = nemret
        self.regionret = regionret
        self.emitlimit = emitlimit
        self.solver = solver
        self.log = log
